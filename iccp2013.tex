...
A typical paper length in ICCP has been 6-8 pages (double column). This is a rough guideline for papers submitted to ICCP 2013. However, there is no arbitrary strict maximum length imposed on ICCP 2013 papers. Reviewers will be instructed to weigh the contribution of a paper relative to its length.
...
, and to specify the  figure width as a multiple of
